---
title: 快照克隆文档
permalink: /docs/snapshotcloneserver.md/
redirect_from: /docs/cn/snapshotcloneserver.md
---

[English version](../snapshotcloneserver_en.md)
...
![快照架构图](/assets/img/images/snap.png)
...
![快照映射表](/assets/img/images/snap-s3-format.png)
...
![clone架构图](/assets/img/images/clone.png)
...
![clone-file-status](/assets/img/images/clone-file-status.png)
...
- CloneMetaInstalled
  ...
  如果文件处于这一状态，说明Chunk的源数据信息都已装载成功，如果用户指定了lazy的方式，此状态下的文件就可以对外提供挂载使用了；此状态过程中，SnapshotCloneServer会去触发各个Chunk从数据源处拷贝数据，此时文件还不允许打快照。
