---
title: monitor 文档
permalink: /docs/monitor.md/
redirect_from: /docs/cn/monitor.md
---

[English version](../monitor_en.md)
...
[client metric](https://github.com/opencurve/curve/tree/master/src/client/client_metric.h)

[chunkserver metric](https://github.com/opencurve/curve/tree/master/src/chunkserver/chunkserver_metrics.h)

[mds topoloy metric](https://github.com/opencurve/curve/tree/master/src/mds/topology/topology_metric.h)

[mds shedule metric](https://github.com/opencurve/curve/tree/master/src/mds/schedule/scheduleMetrics.h)
...
监控目标的配置使用 prometheus 基于文件的服务自动发现功能；监控组件使用docker来部署，用docker-compose来进行编排；部署相关脚本在[ CURVE 仓库中](https://github.com/opencurve/curve/tree/master/monitor)。
...
3. ```python``` 脚本有多个。[target_json.py ](https://github.com/opencurve/curve/tree/master/monitor/target_json.py)用于生成 prometheus 服务发现依赖的监控目标配置，生成的文件为 json 格式；该脚本依赖 [target.ini](https://github.com/opencurve/curve/tree/master/monitor/target.ini.example) 中的配置，从配置中获取 mds、etcd 的信息。[grafana-report.py](https://github.com/opencurve/curve/tree/master/monitor/grafana-report.py) 用于从 Grafana 导出 daily reporter中所需要的数据信息。
...
<img src="/assets/img/images/grafana-example-3.png" alt="monitor" width="1000" />
